# Graph Report - LRHQ  (2026-06-28)

## Corpus Check
- 104 files · ~967,862 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1109 nodes · 1977 edges · 64 communities (53 shown, 11 thin omitted)
...
## Knowledge Gaps
- **282 isolated node(s):** `$schema`, `plugin`, `jstring`, `jobjectArray`, `jint` (+277 more)
