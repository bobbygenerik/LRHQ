# Graph Report - LRHQ  (2026-06-21)

## Corpus Check
- 90 files · ~963,597 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 975 nodes · 1717 edges · 56 communities (47 shown, 9 thin omitted)
...
1. `HomeScreen()` - 25 edges
2. `PersistentChannelRepository` - 25 edges
3. `HqApplication` - 24 edges
4. `FakeIptvDao` - 24 edges
...
Cohesion: 0.11
Nodes (28): Boolean, Channel, Float, ImageVector, Int, Modifier, Shadow, String (+20 more)

### Community 2 - "IPTV Channels & EPG"
Cohesion: 0.07
Nodes (43): LauncherPrefsStore, Modifier, AmbientPhoto, android, Boolean, Channel, FocusRequester, HqApplication (+35 more)

### Community 3 - "Widget Plugin Contract"
Cohesion: 0.06
Nodes (37): Float, Long, Flow, List, StateFlow, String, WeatherCondition, Channel (+29 more)
...
Cohesion: 0.08
Nodes (41): AmbientPhotoCacheStats, Boolean, List, Modifier, String, Boolean, Color, Composable (+33 more)
...
Cohesion: 0.10
Nodes (13): Boolean, ChannelEntity, Flow, GuideChannelEntity, IptvDao, List, Long, ProgramEntity (+5 more)
...
Cohesion: 0.07
Nodes (33): Modifier, WidgetPlugin, WidgetState, Boolean, HqApplication, LaunchableApp, List, Modifier (+25 more)
...
Cohesion: 0.10
Nodes (19): android, Bundle, Channel, HqApplication, Shadow, String, Channel, ExoPlayer (+11 more)
...
Cohesion: 0.06
Nodes (28): Boolean, ImageVector, Modifier, String, Zone, Boolean, Bundle, Int (+20 more)
...
## Knowledge Gaps
- **252 isolated node(s):** `LauncherPrefsStore`, `LrhqDatabase`, `ChannelRepository`, `MediaRepository`, `AmbientInfoRepository` (+247 more)
...
- **Why does `StatBar()` connect `Command Center Dashboard` to `Widget Plugin Contract`, `Community 28`, `System Monitoring`, `Community 23`?**
