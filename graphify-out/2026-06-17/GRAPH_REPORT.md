# Graph Report - LRHQ  (2026-06-17)

## Corpus Check
- 86 files · ~959,702 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 906 nodes · 1591 edges · 56 communities (43 shown, 13 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 110 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b5c07775`
...
Cohesion: 0.05
Nodes (29): Boolean, Bundle, Int, Intent, LauncherNavController, Long, Modifier, Zone (+21 more)

### Community 2 - "IPTV Channels & EPG"
Cohesion: 0.08
Nodes (32): android, LauncherPrefsStore, Modifier, AmbientPhoto, Boolean, HqApplication, LauncherNavController, List (+24 more)
...
Cohesion: 0.16
Nodes (9): Activity, Boolean, Context, LaunchableApp, List, String, LaunchableApp, findActivity() (+1 more)
...
Cohesion: 0.10
Nodes (29): Modifier, WidgetPlugin, WidgetState, Boolean, HqApplication, LaunchableApp, List, Modifier (+21 more)
...
Cohesion: 0.32
Nodes (5): Channel, InputStream, List, String, M3uParser

### Community 28 - "Community 28"
Cohesion: 0.12
Nodes (25): Boolean, Channel, Int, Long, Modifier, String, Boolean, Channel (+17 more)
...
Cohesion: 0.12
Nodes (14): Bundle, Channel, String, Channel, ExoPlayer, Int, String, Tracks (+6 more)

### Community 31 - "Community 31"
Cohesion: 0.18
Nodes (17): Flow, List, StateFlow, String, DownloadJob, AmbientInfoRepository, httpGet(), parseOpenMeteoWeather() (+9 more)
...
## Knowledge Gaps
- **231 isolated node(s):** `PreToolUse`, `PreToolUse`, `plugin`, `LauncherPrefsStore`, `LrhqDatabase` (+226 more)
...
- **Why does `StatBar()` connect `Command Center Dashboard` to `Community 1`, `Community 28`, `System Monitoring`, `Community 23`?**
  _High betweenness centrality (0.214) - this node is a cross-community bridge._
- **Why does `DownloadJob` connect `Command Center Dashboard` to `Widget Plugin Contract`, `Community 31`?**
