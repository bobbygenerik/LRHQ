...
## Corpus Check
- 90 files · ~964,240 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 986 nodes · 1739 edges · 62 communities (52 shown, 10 thin omitted)
...
1. `PersistentChannelRepository` - 27 edges
2. `HomeScreen()` - 25 edges
3. `FakeIptvDao` - 25 edges
...
Cohesion: 0.42
Nodes (9): android, HqApplication, String, AmbientClock(), ambientDate(), ambientMeridiem(), AmbientNowPlaying(), AmbientScreen() (+1 more)
...
Cohesion: 0.15
Nodes (9): Boolean, Bundle, Int, Intent, LauncherNavController, Long, KeyEvent, Edge D-pad navigation pattern (+1 more)
...
Cohesion: 0.15
Nodes (13): Boolean, ImageVector, Modifier, String, Zone, Modifier, StateFlow, String (+5 more)
